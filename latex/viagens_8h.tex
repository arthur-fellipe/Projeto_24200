\doxysection{Refer̻ncia ao ficheiro viagens.\+h}
\hypertarget{viagens_8h}{}\label{viagens_8h}\index{viagens.h@{viagens.h}}
...
\item 
struct \mbox{\hyperlink{struct_viagem}{Viagem}}
\item 
struct \mbox{\hyperlink{struct_lista_viagem}{Lista\+Viagem}}
\end{DoxyCompactItemize}
\doxysubsubsection*{Macros}
\begin{DoxyCompactItemize}
\item 
\#define \mbox{\hyperlink{viagens_8h_af08ec37a8c99d747fb60fa15bc28678b}{\+\_\+\+CRT\+\_\+\+SECURE\+\_\+\+NO\+\_\+\+WARNINGS}}
\end{DoxyCompactItemize}
\doxysubsubsection*{Defini̵̤es de tipos}
\begin{DoxyCompactItemize}
\item 
typedef struct \mbox{\hyperlink{struct_viagem}{Viagem}} \mbox{\hyperlink{viagens_8h_adc225cc6616397bbae8a51b7e6a3c3b7}{Viagem}}
\item 
typedef struct \mbox{\hyperlink{struct_lista_viagem}{Lista\+Viagem}} \mbox{\hyperlink{viagens_8h_a2895ff5f342be85da9702ef9b234ded2}{Lista\+Viagem}}
\end{DoxyCompactItemize}
\doxysubsubsection*{Fun̵̤es}
\begin{DoxyCompactItemize}
\item 
\mbox{\hyperlink{struct_lista_viagem}{Lista\+Viagem}} \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{viagens_8h_ae4d74bedfbddfb7025b4d903c1bc2e7f}{Registar\+Viagem}} (\mbox{\hyperlink{struct_lista_viagem}{Lista\+Viagem}} \texorpdfstring{$\ast$}{*}lista\+Viagem, int id, int cliente\+\_\+id, int veiculo\+\_\+id, float preco\+Viagem, float distancia\+Viagem)
\item 
bool \mbox{\hyperlink{viagens_8h_a872f6f09d208f089e6e98a21bd9e32a3}{Verificar\+Existe\+Viagem}} (\mbox{\hyperlink{struct_lista_viagem}{Lista\+Viagem}} \texorpdfstring{$\ast$}{*}lista\+Viagem, \mbox{\hyperlink{struct_viagem}{Viagem}} \texorpdfstring{$\ast$}{*}nova\+Viagem)
\item 
\mbox{\hyperlink{struct_lista_viagem}{Lista\+Viagem}} \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{viagens_8h_a3d5779e63ef4565635930916528e7750}{Criar\+Lista\+Viagem}} (\mbox{\hyperlink{struct_lista_viagem}{Lista\+Viagem}} \texorpdfstring{$\ast$}{*}lista\+Viagem, \mbox{\hyperlink{struct_viagem}{Viagem}} \texorpdfstring{$\ast$}{*}nova\+Viagem)
\item 
\mbox{\hyperlink{struct_lista_viagem}{Lista\+Viagem}} \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{viagens_8h_ab087245e97cd61b329af6b77b984560a}{Inserir\+Viagem}} (\mbox{\hyperlink{struct_lista_viagem}{Lista\+Viagem}} \texorpdfstring{$\ast$}{*}lista\+Viagem, \mbox{\hyperlink{struct_viagem}{Viagem}} \texorpdfstring{$\ast$}{*}nova\+Viagem)
\item 
bool \mbox{\hyperlink{viagens_8h_a14b09860d8947abfb13acbce6fef7e2e}{Criar\+Lista\+Viagem\+Bin}} (\mbox{\hyperlink{struct_lista_viagem}{Lista\+Viagem}} \texorpdfstring{$\ast$}{*}lista\+Viagem)
\item 
bool \mbox{\hyperlink{viagens_8h_a7a4422a1fe3cc1fa304eda12e7f5830b}{Inserir\+Lista\+Viagem\+Bin}} (\mbox{\hyperlink{struct_lista_viagem}{Lista\+Viagem}} \texorpdfstring{$\ast$}{*}lista\+Viagem)
\item 
\mbox{\hyperlink{struct_lista_viagem}{Lista\+Viagem}} \texorpdfstring{$\ast$}{*} \mbox{\hyperlink{viagens_8h_af88a12db36e6dcd53fdfa1eaf7944a17}{Ler\+Lista\+Viagem\+Bin}} ()
\item 
bool \mbox{\hyperlink{viagens_8h_a59cc8c4c4cf3940bcf57a6bdb164c27b}{Alterar\+Lista\+Viagem\+Bin}} (\mbox{\hyperlink{struct_viagem}{Viagem}} novos\+Dados)
\item 
bool \mbox{\hyperlink{viagens_8h_aeda219374d619bb5c18bd36667b7e912}{Remover\+Dados\+Lista\+Viagem\+Bin}} (int id)
\end{DoxyCompactItemize}
...
\Hypertarget{viagens_8h_af08ec37a8c99d747fb60fa15bc28678b}\label{viagens_8h_af08ec37a8c99d747fb60fa15bc28678b} 
\index{viagens.h@{viagens.h}!\_CRT\_SECURE\_NO\_WARNINGS@{\_CRT\_SECURE\_NO\_WARNINGS}}
\index{\_CRT\_SECURE\_NO\_WARNINGS@{\_CRT\_SECURE\_NO\_WARNINGS}!viagens.h@{viagens.h}}
...
\Hypertarget{viagens_8h_a2895ff5f342be85da9702ef9b234ded2}\label{viagens_8h_a2895ff5f342be85da9702ef9b234ded2} 
\index{viagens.h@{viagens.h}!ListaViagem@{ListaViagem}}
\index{ListaViagem@{ListaViagem}!viagens.h@{viagens.h}}
\doxysubsubsection{\texorpdfstring{ListaViagem}{ListaViagem}}
{\footnotesize\ttfamily typedef struct \mbox{\hyperlink{struct_lista_viagem}{Lista\+Viagem}} \mbox{\hyperlink{struct_lista_viagem}{Lista\+Viagem}}}

\Hypertarget{viagens_8h_adc225cc6616397bbae8a51b7e6a3c3b7}\label{viagens_8h_adc225cc6616397bbae8a51b7e6a3c3b7} 
\index{viagens.h@{viagens.h}!Viagem@{Viagem}}
\index{Viagem@{Viagem}!viagens.h@{viagens.h}}
\doxysubsubsection{\texorpdfstring{Viagem}{Viagem}}
{\footnotesize\ttfamily typedef struct \mbox{\hyperlink{struct_viagem}{Viagem}} \mbox{\hyperlink{struct_viagem}{Viagem}}}



\doxysubsection{Documenta̤̣o das fun̵̤es}
\Hypertarget{viagens_8h_a59cc8c4c4cf3940bcf57a6bdb164c27b}\label{viagens_8h_a59cc8c4c4cf3940bcf57a6bdb164c27b} 
\index{viagens.h@{viagens.h}!AlterarListaViagemBin@{AlterarListaViagemBin}}
\index{AlterarListaViagemBin@{AlterarListaViagemBin}!viagens.h@{viagens.h}}
...
\end{DoxyCode}
\Hypertarget{viagens_8h_a3d5779e63ef4565635930916528e7750}\label{viagens_8h_a3d5779e63ef4565635930916528e7750} 
\index{viagens.h@{viagens.h}!CriarListaViagem@{CriarListaViagem}}
\index{CriarListaViagem@{CriarListaViagem}!viagens.h@{viagens.h}}
...
\end{DoxyCode}
\Hypertarget{viagens_8h_a14b09860d8947abfb13acbce6fef7e2e}\label{viagens_8h_a14b09860d8947abfb13acbce6fef7e2e} 
\index{viagens.h@{viagens.h}!CriarListaViagemBin@{CriarListaViagemBin}}
\index{CriarListaViagemBin@{CriarListaViagemBin}!viagens.h@{viagens.h}}
...
\end{DoxyCode}
\Hypertarget{viagens_8h_a7a4422a1fe3cc1fa304eda12e7f5830b}\label{viagens_8h_a7a4422a1fe3cc1fa304eda12e7f5830b} 
\index{viagens.h@{viagens.h}!InserirListaViagemBin@{InserirListaViagemBin}}
\index{InserirListaViagemBin@{InserirListaViagemBin}!viagens.h@{viagens.h}}
...
\end{DoxyCode}
\Hypertarget{viagens_8h_ab087245e97cd61b329af6b77b984560a}\label{viagens_8h_ab087245e97cd61b329af6b77b984560a} 
\index{viagens.h@{viagens.h}!InserirViagem@{InserirViagem}}
\index{InserirViagem@{InserirViagem}!viagens.h@{viagens.h}}
...
\end{DoxyCode}
\Hypertarget{viagens_8h_af88a12db36e6dcd53fdfa1eaf7944a17}\label{viagens_8h_af88a12db36e6dcd53fdfa1eaf7944a17} 
\index{viagens.h@{viagens.h}!LerListaViagemBin@{LerListaViagemBin}}
\index{LerListaViagemBin@{LerListaViagemBin}!viagens.h@{viagens.h}}
...
\end{DoxyCode}
\Hypertarget{viagens_8h_ae4d74bedfbddfb7025b4d903c1bc2e7f}\label{viagens_8h_ae4d74bedfbddfb7025b4d903c1bc2e7f} 
\index{viagens.h@{viagens.h}!RegistarViagem@{RegistarViagem}}
\index{RegistarViagem@{RegistarViagem}!viagens.h@{viagens.h}}
...
\end{DoxyCode}
\Hypertarget{viagens_8h_aeda219374d619bb5c18bd36667b7e912}\label{viagens_8h_aeda219374d619bb5c18bd36667b7e912} 
\index{viagens.h@{viagens.h}!RemoverDadosListaViagemBin@{RemoverDadosListaViagemBin}}
\index{RemoverDadosListaViagemBin@{RemoverDadosListaViagemBin}!viagens.h@{viagens.h}}
...
\end{DoxyCode}
\Hypertarget{viagens_8h_a872f6f09d208f089e6e98a21bd9e32a3}\label{viagens_8h_a872f6f09d208f089e6e98a21bd9e32a3} 
\index{viagens.h@{viagens.h}!VerificarExisteViagem@{VerificarExisteViagem}}
\index{VerificarExisteViagem@{VerificarExisteViagem}!viagens.h@{viagens.h}}
